...
```bash
git clone \
https://github.com/thescriptingcave/analytical-data-processing-with-trino.git
cd analytical-data-processing-with-trino
```
...
Modifications were made from josephmachado/project - Thanks Joe!